...
class CompactionJob {
 public:
  ...
  void Prepare(
      ...
      log::Writer* resumable_compaction_progress_writer = nullptr);
 ...
 private:
  ...
  // Writer for persisting resumable compaction progress during compaction
  log::Writer* resumable_compaction_progress_writer_ = nullptr;
