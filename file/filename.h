...
extern const std::string
    kResumableCompactionProgressFileNamePrefix;  // =
...
// Return a resumable compaction progress file name given the timestamp.
// Format:  RESUMABLE_COMPACTION_PROGRESS-[timestamp]
std::string ResumableCompactionProgressFileName(const std::string& dbname,
                                                uint64_t timestamp);

// Return a temp resumable compaction progress file name given the timestamp.
// Format:  RESUMABLE_COMPACTION_PROGRESS-[timestamp].dbtmp
